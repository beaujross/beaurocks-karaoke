...
> Requested Search Queries allocation: 1,000 calls/day
> Requested Search Queries peak: 30 calls/minute
...
>
> We requested 1,000 Search Queries calls/day with a 30-calls/minute peak. This supports a modeled five-hour, 150-person high-engagement event of approximately 750 uncached live searches plus contingency. The application reduces live demand through multiple cache layers, verified indexed and canonical backing reuse, known-ID refresh, host-provided URLs, and quota cooldown behavior.
>
> Public URLs:
>
