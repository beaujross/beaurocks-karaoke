...
const run = () => {
  ...
  assertIncludes(singerApp, "roomCode,\n            sourceUid", "ui_sends_room_and_migration_context", results);
  ...
  assertIncludes(functionsIndex, "const rewardPoints = 5000;", "callable_owns_vip_reward_amount", results);
  assertIncludes(functionsIndex, "room_event_credit_grant:${grantId}", "callable_records_idempotent_vip_reward", results);
