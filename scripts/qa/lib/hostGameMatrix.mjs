const HOST_GAME_MATRIX = [
  ...
  },
  {
    ...
    audienceSelector: "[data-prompt-vote-player-view='trivia']",
    tvRegex: /trivia|responses locked|pick the correct answer/i,
    tvSelector: "[data-prompt-vote-tv-view='trivia']",
    interaction: {
      type: "click_selector",
  ...
  },
  {
    ...
    audienceSelector: "[data-prompt-vote-player-view='wyr']",
    tvRegex: /would you rather|crowd split|option a|option b/i,
    tvSelector: "[data-prompt-vote-tv-view='wyr']",
    interaction: {
      type: "click_selector",
  ...
  },
  {
    ...
    audienceSelector: "[data-feature-id='singer-doodle-oke']",
    tvRegex: /doodle-oke|sketch the lyric|waiting for sketches/i,
    tvSelector: "[data-feature-id='tv-doodle-oke']",
    fixture: {
      singers: [
        { name: "QA Sketch Artist" },
        { name: "QA Sketch Voter" },
      ],
    },
  },
  {
    ...
    audienceSelector: "[data-feature-id='singer-selfie-challenge']",
    tvRegex: /selfie challenge|waiting for selfies|strike a pose|vote/i,
    tvSelector: "[data-feature-id='tv-selfie-challenge']",
    fixture: {
      singers: [
        { name: "QA Selfie Star" },
        { name: "QA Selfie Voter" },
      ],
    },
  },
  {
    ...
    audienceRegex: /sweet 16 bracket|karaoke tournament|audience vote|match/i,
    audienceSelector: "[data-feature-id='singer-bracket-live']",
    tvRegex: /sweet 16 bracket|karaoke tournament|round complete|match/i,
    tvSelector: "[data-feature-id='tv-bracket-live']",
    fixture: {
      singers: [
        {
          name: "Bracket One",
