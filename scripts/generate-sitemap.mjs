...
const buildRouteHtml = (templateHtml = "", routeRecord = {}) => {
  ...
  const headTags = [
    `    <script>document.documentElement.classList.add("br-js");</script>`,
    ...
    `    <style>html.br-js,html.br-js body{background:#090612}.br-js .seo-static-shell{visibility:hidden}</style>`,
