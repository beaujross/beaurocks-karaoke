...
export const GAMES_META = [
    ...
    },
    {
        id: 'flappy_bird',
        name: 'Flappy Bird',
        description: 'Voice volume steers flight through roomy obstacle runs.',
        goal: 'Stay in the air, grab coins, and celebrate big saves.',
        howToPlay: 'Keep a tone going, burst louder to rise, tap anytime.',
