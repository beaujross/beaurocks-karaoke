...
export const GAMES_META = [
    ...
    },
    {
        id: 'flappy_bird',
        name: 'Pitch Runner',
        description: 'A crowd-singalong runner where the room steers through forgiving note gates.',
        goal: 'Stay inside each note gap, recover quickly, and keep the room alive for one more run.',
        howToPlay: 'Calibrate once, then sing the target line together and use Breath when needed.',
    ...
    },
    {
        ...
        description: 'A forgiving follow-the-note game built for the whole room to sing along.',
        goal: 'Keep singing, stack streaks, and let near matches keep momentum up.',
        howToPlay: 'Follow the glowing note and stay close because misses are softened.',
        playModes: ['Crowd mic', 'Solo singer'],
        icon: 'fa-solid fa-wave-square',
        category: 'voice',
        badge: 'Voice',
