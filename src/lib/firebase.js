...
const listMyAdditionalUsageTransactions = async (opts = {}) => {
  await requireAppCheckToken("listMyAdditionalUsageTransactions");
  const data = await callFunction("listMyAdditionalUsageTransactions", opts || {});
  return data || null;
};
