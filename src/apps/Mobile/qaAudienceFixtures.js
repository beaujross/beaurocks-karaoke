...
const buildAahfRoom = ({ roomCode = DEFAULT_ROOM_CODE, shellVariant = 'streamlined', activeMode = 'karaoke' } = {}) => ({
    ...
    eventCredits: {
        ...
        supportBadge: true,
        supportOffers: [
            { id: 'solo_boost', label: 'Solo Boost', amount: 5, points: 1200, rewardScope: 'buyer', awardBadge: false },
            { id: 'stage_starter', label: 'Stage Starter', amount: 10, points: 3000, rewardScope: 'buyer', awardBadge: false },
            { id: 'headliner', label: 'Headliner', amount: 20, points: 7500, rewardScope: 'buyer', awardBadge: false },
        ],
