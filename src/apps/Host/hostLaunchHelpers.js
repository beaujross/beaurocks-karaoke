...
export const EVENT_CREDITS_PRESETS = Object.freeze({
    ...
    custom_event_credits: {
        ...
        values: {
            ...
            supportOffers: [],
            audienceAccessMode: AUDIENCE_ACCESS_MODES.account,
            creditEarningMode: CREDIT_EARNING_MODES.playful,
            coHostCreditPolicy: CO_HOST_CREDIT_POLICIES.standard,
            reactionTapCooldownMs: DEFAULT_REACTION_TAP_COOLDOWN_MS,
            timedLobbyEnabled: true,
            timedLobbyPoints: 50,
    ...
    promo_campaigns: {
        ...
        values: {
            ...
            supportOffers: [],
            audienceAccessMode: AUDIENCE_ACCESS_MODES.account,
            creditEarningMode: CREDIT_EARNING_MODES.lean,
            coHostCreditPolicy: CO_HOST_CREDIT_POLICIES.standard,
            reactionTapCooldownMs: DEFAULT_REACTION_TAP_COOLDOWN_MS,
            timedLobbyEnabled: false,
            timedLobbyPoints: 0,
    ...
    aahf_kickoff: {
        ...
        description: 'AAHF kickoff defaults for May 1 from 7 PM to midnight with simple donation prompts and passive room credits.',
        values: {
            enabled: true,
            ...
            timedLobbyEnabled: true,
            timedLobbyPoints: 12,
            timedLobbyIntervalMin: 8,
            timedLobbyMaxPerGuest: 72,
            supportCelebrationStyle: SUPPORT_CELEBRATION_STYLES.standard,
            promoCampaigns: [],
        },
    },
...
export const createEventCreditsDraft = (draft = {}) => {
    ...
    return {
        ...
        creditEarningMode: normalizeCreditEarningMode(source.creditEarningMode || DEFAULT_EVENT_CREDITS_CONFIG.creditEarningMode),
        coHostCreditPolicy: normalizeCoHostCreditPolicy(source.coHostCreditPolicy || DEFAULT_EVENT_CREDITS_CONFIG.coHostCreditPolicy),
        reactionTapCooldownMs: normalizeReactionTapCooldownMs(source.reactionTapCooldownMs ?? DEFAULT_EVENT_CREDITS_CONFIG.reactionTapCooldownMs),
        timedLobbyEnabled: source.timedLobbyEnabled === true,
        timedLobbyPoints: clampWholeNumber(source.timedLobbyPoints ?? DEFAULT_EVENT_CREDITS_CONFIG.timedLobbyPoints, { min: 0, max: 1000 }),
        timedLobbyIntervalMin: clampWholeNumber(source.timedLobbyIntervalMin ?? DEFAULT_EVENT_CREDITS_CONFIG.timedLobbyIntervalMin, { min: 1, max: 120 }),
        timedLobbyMaxPerGuest: clampWholeNumber(source.timedLobbyMaxPerGuest ?? DEFAULT_EVENT_CREDITS_CONFIG.timedLobbyMaxPerGuest, { min: 0, max: 10000 }),
...
export const buildProvisionEventCreditsPayload = (draft = {}) => {
    ...
    return {
        ...
        creditEarningMode: normalizeCreditEarningMode(nextDraft.creditEarningMode || ''),
        coHostCreditPolicy: normalizeCoHostCreditPolicy(nextDraft.coHostCreditPolicy || ''),
        reactionTapCooldownMs: normalizeReactionTapCooldownMs(nextDraft.reactionTapCooldownMs),
        timedLobbyEnabled: nextDraft.timedLobbyEnabled === true,
        timedLobbyPoints: clampWholeNumber(nextDraft.timedLobbyPoints, { min: 0, max: 1000 }),
        timedLobbyIntervalMin: clampWholeNumber(nextDraft.timedLobbyIntervalMin, { min: 1, max: 120 }),
        timedLobbyMaxPerGuest: clampWholeNumber(nextDraft.timedLobbyMaxPerGuest, { min: 0, max: 10000 }),
