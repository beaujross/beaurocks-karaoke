...
export const compileMissionDraftToRoomPayload = (draft = {}, _capabilities = {}, options = {}) => {
    ...
    return {
        ...
        autoBonusPoints: Math.max(0, Math.min(1000, toNumber(presetSettings.autoBonusPoints, 25))),
        autoDjDelaySec: Math.max(2, Math.min(45, toNumber(presetSettings.autoDjDelaySec, 10))),
        ...
        hypeMeterDisplayMode: presetSettings.hypeMeterDisplayMode || 'score_integrated',
