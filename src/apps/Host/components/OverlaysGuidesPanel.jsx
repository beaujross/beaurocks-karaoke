    ...
    <>
        ...
        <div className={showVibeSync && vibeSyncOpen ? 'rounded-2xl border border-zinc-700 bg-zinc-950/60 p-3' : 'hidden'}>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-2">
                ...
                }} className={`flex items-center justify-center gap-2 py-2 rounded-lg border ${room?.lightMode === 'guitar' ? 'bg-pink-500 text-black border-pink-300' : 'bg-zinc-900/80 text-zinc-200 border-white/10 hover:border-pink-400/40'}`} title="Turn an instrumental break into a crowd-powered solo"><i className="fa-solid fa-guitar"></i> Guitar Solo</button>
